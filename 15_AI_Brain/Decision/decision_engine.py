...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent / "16_ClinicOS_CLI" / "cli"))
...
class DecisionEngine:
    ...
    def interactive_decision_flow(self):
        ...
        module = input("Module Name (e.g., 15_AI_Brain/Decision): ").strip() or "15_AI_Brain/Decision"
