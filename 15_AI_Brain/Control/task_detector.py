...
sys.path.insert(0, str(REPO_ROOT / "15_AI_Brain"))
sys.path.insert(0, str(REPO_ROOT / "15_AI_Brain" / "Control"))
sys.path.insert(0, str(REPO_ROOT / "15_AI_Brain" / "Core"))
os.chdir(REPO_ROOT)
...
INBOX_DIR = REPO_ROOT / "15_BrainOS" / "TaskInbox"
PROCESSING_DIR = INBOX_DIR / "processing"
PROCESSED_DIR = INBOX_DIR / "processed"
FAILED_DIR = INBOX_DIR / "failed"
MEMORY_PATH = REPO_ROOT / "15_BrainOS" / "BRAIN_MEMORY.md"
