...
detector_status=0
"$PYTHON_BIN" development/15_AI_Brain/Control/task_detector.py || detector_status=$?

scheduler_status=0
"$PYTHON_BIN" development/15_AI_Brain/Control/scheduler.py --once || scheduler_status=$?
