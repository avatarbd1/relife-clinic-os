...
cd ~/relife-clinic-os
echo "===MASTER_PROMPT===" && cat development/11_AIOS/MASTER_PROMPT.md
echo "===AI_CONSTITUTION===" && cat development/11_AIOS/AI_CONSTITUTION.md
echo "===AI_REGISTRY===" && cat development/11_AIOS/AI_REGISTRY.md
echo "===HANDOVER===" && cat development/12_Handover/HANDOVER.md
echo "===TASK_QUEUE===" && cat development/13_AI_Tasks/TASK_QUEUE.md
