...
REPORT = Path(
"development/15_AI_Brain/Integration/V1/reports/CLINIC_DAILY_BRIEF.md"
)
...
patient = load_file(
"development/15_AI_Brain/Integration/V1/reports/patient_insight.json"
)

staff = load_file(
"development/15_AI_Brain/Integration/V1/reports/staff_performance.json"
)

finance = load_file(
"development/15_AI_Brain/Integration/V1/reports/finance_insight.json"
)
