...
BASE = Path(".")
REPORT_DIR = Path("development/15_AI_Brain/Automation/V1/reports")
...
def scan_tasks():
    file = BASE / "development/13_AI_Tasks/TASK_QUEUE.md"
...
def scan_ai_registry():
    file = BASE / "development/11_AIOS/AI_REGISTRY.md"
