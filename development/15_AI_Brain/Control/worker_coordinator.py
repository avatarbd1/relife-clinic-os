...
Coordinates human-facing AI worker IDs from ``development/11_AIOS/AI_REGISTRY.md``
against the shared ``development/13_AI_Tasks/TASK_QUEUE.md``.  Provider routing remains a
...
class WorkerCoordinator:
    def __init__(
        ...
        self.registry = registry or ROOT / "development/11_AIOS" / "AI_REGISTRY.md"
        self.queue = queue or ROOT / "development/13_AI_Tasks" / "TASK_QUEUE.md"
        self.handover = handover or ROOT / "development/12_Handover" / "HANDOVER.md"
        self.lock_path = lock_path or ROOT / "development/15_AI_Brain" / "Logs" / "brainos.lock"
        self.brain_queue = brain_queue or ROOT / "development/15_BrainOS" / "BRAIN_QUEUE.md"
