...
REPORT_PATH = PROJECT_ROOT / "development/15_AI_Brain" / "Monitor" / "PHASE2_PROGRESS.md"

PHASE2_ITEMS = [
    ("1. Task Executor", "development/15_AI_Brain/Core/task_executor.py"),
    ("2. Dry-Run + Confirm Gate", "development/15_AI_Brain/Control/confirm_gate.py"),
    ("3. Output Validator", "development/15_AI_Brain/Core/output_validator.py"),
    ("4. Task Result Logger", "development/15_AI_Brain/Logs/TASK_RESULTS.jsonl"),
    ("5. Scheduler", "development/15_AI_Brain/Control/scheduler.py"),
    ("6. Failure Alerting", "development/15_AI_Brain/Control/alert_notifier.py"),
    ("7. Concurrency Lock", "development/15_AI_Brain/Control/concurrency_lock.py"),
    ("8. Progress Dashboard", "development/15_AI_Brain/Monitor/DASHBOARD.md"),
]
