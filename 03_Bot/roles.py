...
MENU_CASH_RECEIVE = "✅ ক্যাশ গ্রহণ"
MENU_CASH_MOVEMENTS = "🔄 ক্যাশ মুভমেন্ট"
...
ROLE_HIDDEN_MENU_ITEMS: dict[Role, list[str]] = {
    Role.OWNER: [
        ...
        MENU_SALARY, MENU_SALARY_HISTORY, MENU_MY_PAYMENTS, MENU_ADD_EXPENSE, MENU_EXPENSE_TRACKER,
        MENU_CASH_RECEIVE, MENU_CASH_MOVEMENTS,
    ],
    Role.RECEPTIONIST: [
        MENU_ATTENDANCE, MENU_TODAY_APPOINTMENTS,
        MENU_PATIENT_REG, MENU_PATIENT_LIST,
        MENU_DAILY_REGISTER,
...
ROLE_FINANCE_ITEMS: dict[Role, list[str]] = {
    Role.OWNER: [MENU_SALARY, MENU_SALARY_HISTORY, MENU_MY_PAYMENTS, MENU_ADD_EXPENSE, MENU_EXPENSE_TRACKER, MENU_CASH_RECEIVE, MENU_CASH_MOVEMENTS],
    Role.RECEPTIONIST: [MENU_CASH_HANDOVER, MENU_CASH_MOVEMENTS],
    Role.MANAGER: [MENU_ADD_EXPENSE, MENU_EXPENSE_TRACKER, MENU_CASH_RECEIVE, MENU_CASH_MOVEMENTS],
}
