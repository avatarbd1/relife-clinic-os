...
MENU_FINANCE_OVERVIEW = "📒 Finance Overview"
...
ROLE_MENU_ROWS: dict[Role, list[list[str]]] = {
    ...
    Role.DENTIST: [
        ...
        [MENU_TREATMENT_NOTE, MENU_TREATMENT_HISTORY],
...
ROLE_HIDDEN_MENU_ITEMS: dict[Role, list[str]] = {
    ...
    Role.DENTIST: [MENU_APPOINTMENT],
}


DENTAL_TEMP_DATA_ENTRY_ROWS: list[list[str]] = [
    [MENU_PATIENT_REG, MENU_PATIENT_LIST],
    [MENU_APPOINTMENT, MENU_TODAY_APPOINTMENTS],
    [MENU_TREATMENT_NOTE, MENU_PATIENT_HISTORY],
    [MENU_PAYMENT, MENU_REPORTS],
]

DENTAL_TEMP_DATA_ENTRY_ITEMS = frozenset(
    item for row in DENTAL_TEMP_DATA_ENTRY_ROWS for item in row
) | frozenset({MENU_TREATMENT_HISTORY, MENU_DAILY_REGISTER})
